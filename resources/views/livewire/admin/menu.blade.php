...
<div class="mt-10 flex flex-col gap-2 overflow-y-auto  text-neutral-400 h-full">
    ...
    <div>
        ...
        <a wire:navigate href="{{ route('admin.academic-year') }}"
            class="flex items-center rounded-md gap-3 px-2 py-1.5 font-medium text-lg underline-offset-2 focus:outline-none
    {{ request()->routeIs('admin.academic-year') ? 'bg-black/30 text-white' : 'hover:bg-black/20' }}">
        ...
        <a wire:navigate href="{{ route('admin.students') }}"
            class="flex items-center rounded-md gap-3 px-2 py-1.5 font-medium text-lg underline-offset-2 focus:outline-none
            {{ request()->routeIs('admin.students') ? 'bg-black/30 text-white' : 'hover:bg-black/20' }}">
        ...
        <a wire:navigate href="{{ route('admin.supervisors') }}"
            class="flex items-center rounded-md gap-3 px-2 py-1.5 font-medium text-lg underline-offset-2 focus:outline-none
    {{ request()->routeIs('admin.supervisors') ? 'bg-black/30 text-white' : 'hover:bg-black/20' }}">
        ...
        <div x-data="{
        ...
        }" x-init="$watch('open', value => localStorage.setItem('documentsOpen', value))" class="relative">
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-100"
                ...
                x-transition:leave-end="transform opacity-0 scale-95" class="pl-8 mt-1 space-y-1">
