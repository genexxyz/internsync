<div class="p-6">
    <!-- Header -->
    <div class="mb-6">
        <h2 class="text-lg font-medium text-gray-900">Import Instructors</h2>
        <p class="mt-1 text-sm text-gray-600">
            Upload instructors data using CSV file format.
        </p>
    </div>
        ...
        >
            @foreach($academics as $academic)
                <option value="{{ $academic->id }}">
                    {{ $academic->academic_year }} - {{ $academic->semester }} Semester
                </option>
            @endforeach
        </select>
    </div>
    ...
    <div class="flex justify-end gap-3">
        ...
        >
            <span wire:loading.remove>Import Instructors</span>
            <span wire:loading>
