            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 p-2 bg-gray-50 rounded-md">
                            {{ $supervisor->department->company->company_name }}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 p-2 bg-gray-50 rounded-md">
                            {{ $supervisor->department->department_name }}
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-10 pt-6 border-t border-gray-200">
                ...
                <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-xs text-gray-500">Last updated: {{ Carbon\Carbon::parse($supervisor->updated_at)->diffForHumans() }}</span>
                    </div>
                    ...
                    >
                        ...
                        >
                            <img 
                                src="{{ Storage::url($supervisor->signature_path) }}" 
